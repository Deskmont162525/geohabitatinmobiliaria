export const slides = [
  ...
  {
    imgClass: "images/slider/4.jpg",
    title: "2 Bed Rooms and 1 Dinning Room Aparment on Sale",
    location: "1890 Syndey, Australia",
    quote:
      "Until he extends the circle of hiscompassion to all living things, man will not himself find peace.",
    price: "$ 20,000,000",
  },
  {
    imgClass: "images/slider/5.jpg",
    title: "2 Bed Rooms and 1 Dinning Room Aparment on Sale",
    location: "1890 Syndey, Australia",
    quote:
      "Until he extends the circle of hiscompassion to all living things, man will not himself find peace.",
...
export const dataCards = [
  {
    ...
    celphone: "555-555-5555",
    urlImage: "images/agents/1.jpg"
  },
  {
    name: "Agente 2",
    description: "Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.",
    correo: "agente2@example.com",
    celphone: "555-555-5556",
    urlImage: "images/agents/2.jpg"
  },
  {
    name: "Agente 3",
    description: "Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.",
  ...
  },
  {
    ...
    correo: "agente2@example.com",
    celphone: "555-555-5556",
    urlImage: "images/agents/4.jpg"
  }
];


export const dataAdmins = [
  {
    imgUrl: "https://primefaces.org/cdn/primereact/images/product/bamboo-watch.jpg",
    name: "Agente 1",
    description: "Descripción del agente 1.",
    correo: "correo1@realestate.com",
    celphone: "123456789",
    color: "#007bff"
  },
  {
    imgUrl: "https://primefaces.org/cdn/primereact/images/product/bamboo-watch.jpg",
    name: "Agente 2",
    description: "Descripción del agente 2.",
    correo: "correo2@realestate.com",
    celphone: "987654321",
    color: "#28a745"
  },
  {
    imgUrl: "https://primefaces.org/cdn/primereact/images/product/bamboo-watch.jpg",
    name: "Agente 3",
    description: "Descripción del agente 3.",
    correo: "correo3@realestate.com",
    celphone: "555123456",
    color: "#dc3545"
  }
];
