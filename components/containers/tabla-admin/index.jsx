...
import { dataTableAdmin } from '../../../data/objets';
...
const TablaAdmin = () => {
    ...
    const [products, setProducts] = useState(dataTableAdmin?.data);
        ...
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    {/* <Column field="rating" header="Reviews" body={ratingBodyTemplate} sortable style={{ minWidth: '8rem' }}></Column> */}
                    <Column field="inventoryStatus" header="Status" body={statusBodyTemplate} sortable style={{ minWidth: '8rem' }}></Column>
                    <Column body={actionBodyTemplate} exportable={false} style={{ minWidth: '8rem' }}></Column>
                </DataTable>
            </div>

            <Dialog visible={productDialog} style={{ width: '550px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
